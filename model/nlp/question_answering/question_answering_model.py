...
from model.nlp.config.model_args import QuestionAnsweringArgs
from model.nlp.config.utils import sweep_config_to_sweep_values
from model.nlp.question_answering.question_answering_utils import (
...
class QuestionAnsweringModel:
    ...
    def eval_model_by_offical_script(self, eval_data, eval_data_path, output_dir=None, verbose=False,
        ...
        f = os.popen("python ./../model/nlp/question_answering/evaluate-v1.1.py %s %s" % (
