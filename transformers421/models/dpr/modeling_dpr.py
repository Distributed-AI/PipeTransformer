...
class DPRContextEncoder(DPRPretrainedContextEncoder):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import DPRContextEncoder, DPRContextEncoderTokenizer
...
class DPRQuestionEncoder(DPRPretrainedQuestionEncoder):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import DPRQuestionEncoder, DPRQuestionEncoderTokenizer
...
class DPRReader(DPRPretrainedReader):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import DPRReader, DPRReaderTokenizer
