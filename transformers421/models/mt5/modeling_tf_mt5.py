...
class TFMT5Model(TFT5Model):
    ...
    Examples::
        >>> from transformers421 import TFMT5Model, T5Tokenizer
...
class TFMT5ForConditionalGeneration(TFT5ForConditionalGeneration):
    ...
    Examples::
        >>> from transformers421 import TFMT5ForConditionalGeneration, T5Tokenizer
...
class TFMT5EncoderModel(TFT5EncoderModel):
    ...
    Examples::
        ...
        >>> from transformers421 import TFMT5EncoderModel, T5Tokenizer
