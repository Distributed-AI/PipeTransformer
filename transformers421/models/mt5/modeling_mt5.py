...
class MT5Model(T5Model):
    ...
    Examples::
        >>> from transformers421 import MT5Model, T5Tokenizer
...
class MT5ForConditionalGeneration(T5ForConditionalGeneration):
    ...
    Examples::
        >>> from transformers421 import MT5ForConditionalGeneration, T5Tokenizer
...
class MT5EncoderModel(T5EncoderModel):
    ...
    Examples::
        ...
        >>> from transformers421 import MT5EncoderModel, T5Tokenizer
