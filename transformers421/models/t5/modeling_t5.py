...
class T5Model(T5PreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from transformers421 import T5Tokenizer, T5Model
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import T5Tokenizer, T5ForConditionalGeneration
...
class T5EncoderModel(T5PreTrainedModel):
    ...
    def forward(
        ...
        Example::
            ...
            >>> from transformers421 import T5Tokenizer, T5EncoderModel
            >>> tokenizer = T5Tokenizer.from_pretrained('t5-small')
