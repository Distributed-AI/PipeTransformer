...
class LayoutLMModel(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import LayoutLMTokenizer, LayoutLMModel
            >>> import torch
...
class LayoutLMForMaskedLM(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import LayoutLMTokenizer, LayoutLMForMaskedLM
            >>> import torch
...
class LayoutLMForSequenceClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import LayoutLMTokenizer, LayoutLMForSequenceClassification
            >>> import torch
...
class LayoutLMForTokenClassification(LayoutLMPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import LayoutLMTokenizer, LayoutLMForTokenClassification
            >>> import torch
