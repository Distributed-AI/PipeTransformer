...
class TapasModel(TapasPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import TapasTokenizer, TapasModel
            >>> import pandas as pd
    ...
    def forward(
        ...
        **kwargs
        ...
        Examples::
            ...
            >>> from transformers421 import TapasTokenizer, TapasForMaskedLM
            >>> import pandas as pd
...
class TapasForQuestionAnswering(TapasPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import TapasTokenizer, TapasForQuestionAnswering
            >>> import pandas as pd
...
class TapasForSequenceClassification(TapasPreTrainedModel):
    ...
    def forward(
        ...
        Examples::
            ...
            >>> from transformers421 import TapasTokenizer, TapasForSequenceClassification
            >>> import torch
            >>> import pandas as pd
