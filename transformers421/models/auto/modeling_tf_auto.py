...
class TFAutoModel(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModel
...
class TFAutoModelForPreTraining(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForPreTraining
            >>> # Download configuration from huggingface.co and cache.
...
class TFAutoModelWithLMHead(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelWithLMHead
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForCausalLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForCausalLM
            >>> # Download configuration from huggingface.co and cache.
...
class TFAutoModelForMaskedLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForMaskedLM
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForSeq2SeqLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForSeq2SeqLM
            >>> # Download configuration from huggingface.co and cache.
...
class TFAutoModelForSequenceClassification(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForSequenceClassification
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForQuestionAnswering(object):
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForQuestionAnswering
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForTokenClassification:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForTokenClassification
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForMultipleChoice:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForMultipleChoice
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class TFAutoModelForNextSentencePrediction:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, TFAutoModelForNextSentencePrediction
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
