...
class AutoModel:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModel
...
class AutoModelForPreTraining:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForPreTraining
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelWithLMHead:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelWithLMHead
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForCausalLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForCausalLM
            >>> # Download configuration from huggingface.co and cache.
...
class AutoModelForMaskedLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForMaskedLM
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForSeq2SeqLM:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForSeq2SeqLM
            >>> # Download configuration from huggingface.co and cache.
...
class AutoModelForSequenceClassification:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForSequenceClassification
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForQuestionAnswering:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForQuestionAnswering
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForTableQuestionAnswering:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForTableQuestionAnswering
            >>> # Download configuration from huggingface.co and cache.
...
class AutoModelForTokenClassification:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForTokenClassification
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForMultipleChoice:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForMultipleChoice
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
...
class AutoModelForNextSentencePrediction:
    ...
    def from_config(cls, config):
        ...
        Examples::
            ...
            >>> from transformers421 import AutoConfig, AutoModelForNextSentencePrediction
            >>> # Download configuration from huggingface.co and cache.
            >>> config = AutoConfig.from_pretrained('bert-base-uncased')
