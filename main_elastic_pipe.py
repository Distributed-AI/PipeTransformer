...
def train(args, auto_pipe, auto_dp, frozen_model, pipe_model, epoch, cv_data, train_dataloader, test_dataloader):
    if auto_freeze.is_freeze_open():
        ...
        frozen_model, pipe_model, is_pipe_len_changed, is_frozen_layer_changed = auto_dp.transform(auto_pipe, frozen_model, pipe_model,
...
if __name__ == "__main__":
    ...
    frozen_model, pipe_model, is_pipe_len_changed, is_frozen_layer_changed = auto_dp.transform(auto_pipe, None, model, 0, freeze_point)
