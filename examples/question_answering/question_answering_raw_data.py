...
def main(args):
    ...
    train_data = pipe_transformer.data.SQuAD_1_1.data_loader.get_normal_format(train_data, cut_off=None)
    test_data = pipe_transformer.data.SQuAD_1_1.data_loader.get_normal_format(test_data, cut_off=None)
