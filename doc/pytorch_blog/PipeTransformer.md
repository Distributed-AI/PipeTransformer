...
\paragraph{Hardware.} Experiments were conducted on 2 identical machines connected by InfiniBand CX353A ($5$GB/s), where each machine is equipped with 8 NVIDIA Quadro RTX 5000 (16GB GPU memory). GPU-to-GPU bandwidth within a machine (PCI 3.0, 16 lanes) is $15.754$GB/s.
